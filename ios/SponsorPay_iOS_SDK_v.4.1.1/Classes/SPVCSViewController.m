...
- (void)dealloc {
    [_sendRequestGroup release];
    [_requestLTIDView release];
    [_responseLTIDView release];
    [_responseDeltaOfCoinsView release];
    [_transactionIDsGroup release];
    [_deltaOfCoinsGroup release];
    [super dealloc];
}
- (void)viewDidUnload {
